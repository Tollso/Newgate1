  ...
  return (
    <div className="h-full flex flex-col lg:flex-row bg-slate-900 text-white animate-fade-in font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col bg-slate-900 relative">
        <div className="p-3 md:p-6 border-b border-slate-800 flex flex-col gap-3 md:gap-4 sticky top-0 z-10 bg-slate-900/90 backdrop-blur-md shrink-0">
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex gap-1.5 md:gap-2 shrink-0">
               <button className="p-2 md:p-3 bg-slate-800 hover:bg-slate-700 rounded-xl text-slate-400 hover:text-white transition-colors" title="Apply Discount"><Percent size={18} className="md:w-5 md:h-5" /></button>
               <button className="p-2 md:p-3 bg-slate-800 hover:bg-slate-700 rounded-xl text-slate-400 hover:text-white transition-colors" title="Split Checks"><SplitSquareHorizontal size={18} className="md:w-5 md:h-5" /></button>
        ...
        <div className="p-3 md:p-6 border-t border-slate-800 bg-slate-950 flex justify-between items-center shrink-0">
           <div className="flex items-end gap-3 md:gap-6 text-slate-400">
             <div>
             ...
             <div className="text-white">
               ...
               <p className="font-mono font-black text-2xl leading-none">\${total.toFixed(2)}</p>
             </div>
           </div>
           
           <div className="flex gap-2 md:gap-3">
             <button onClick={onFire} className="px-8 py-4 bg-orange-600 hover:bg-orange-500 text-white font-bold rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-orange-900/20 transition-all active:scale-95">
               <Flame size={20} /> <span className="tracking-wide">Send to Kitchen</span>
             </button>
             <button onClick={onOpenPayment} className="px-8 py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-emerald-900/20 transition-all active:scale-95">
               <CreditCard size={20} /> <span className="tracking-wide">Pay Check</span>
             </button>
           </div>
        </div>
      </div>
...
console.log('Order panel rewritten');
